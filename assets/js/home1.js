document.addEventListener("DOMContentLoaded", () => {
	const popularSlider = document.querySelector(
	...
	if (heroSliderWrapper) {
		...
		function showSlide(index) {
			...
			heroSliderWrapper.style.transform =
...
if (testimonialsSlider) {
	...
	function startAutoScroll() {
		...
		const scrollDuration = window.innerWidth <= 768 ? "5s" : "20s";
		...
		testimonialsSlider.style.animation = `scroll ${scrollDuration} linear infinite`;
	}
